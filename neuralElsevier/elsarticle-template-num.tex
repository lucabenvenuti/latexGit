...
To avoid numeric instability and wall effects numerous particles must be used, thus increasing the time needed for each simulation.
Furthermore, each combination of DEM-micro parameters gets different bulk-macro values.
As a consequence the total simulation time goes to infinite.
...
The DEM parameters of the simulations have been used as inputs of feed forward MLPNN, while the bulk values as targets.
