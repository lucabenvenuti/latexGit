...
\begin{figure}[htp] \centering
        ...
        \includegraphics[width=0.5\textwidth]{26radarpirker08schulze10070}
        \caption{Parameter space plot, $SSC$, $\sigma_n=10070$ Pa, P=0.8}
        \label{fig:26radarpirker08schulze10070} 
    \end{subfigure}\\
     \begin{subfigure}[b]{0.4\columnwidth}
        \includegraphics[width=0.5\textwidth]{24radarpirker1schulze10070}
    ...
    \end{subfigure} \\
        ...
        \includegraphics[width=0.5\textwidth]{28radarpirker12schulze10070}
