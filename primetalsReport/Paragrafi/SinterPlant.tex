...
\input{Immagini/057sinterChuteOrtoLayout}
...
\input{Immagini/056sinterChuteBox}
...
\input{Immagini/055sinterChuteVerticalLayout}
\input{Immagini/067sinterchute}

\section{Results}
\label{sec:results}

\input{Immagini/097particlespositions}
\input{Paragrafi/radii}
...
\input{Immagini/066sinterbarplot}
\input{Paragrafi/parameters}
