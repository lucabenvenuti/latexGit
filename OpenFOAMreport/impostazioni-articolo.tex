...
\newcommand{\myTitle}{OpenFOAM\textregistered  Course Report} % titolo
...
% dipartimento
\newcommand{\myProf}{DI~Dr.~Gijsbert \textsc{Wierink}}      % relatore
\newcommand{\myOtherProf}{DI~Dr.~Christoph \textsc{Kloss}}    
\newcommand{\myOtherProff}{DI~Dr.~Stefan \textsc{Pirker}}              % eventuale correlatore
...
\newcommand{\myPhd}{Heat transfer in a porous media} % titolo
