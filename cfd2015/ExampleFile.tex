...
faithfully model particle bulk behaviour \cite{RefWorks:86}. \\
...
based on the work of \citet{RefWorks:143}. 
...
\begin{figure}%[!htb] 
\centering 
\includegraphics[width=.96\columnwidth]{42particleDistributionChute} 
\caption{trota}
