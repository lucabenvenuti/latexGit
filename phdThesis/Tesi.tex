...
\input{Capitoli/Motivation}
\input{Capitoli/Insufficiency}
\input{Capitoli/LiteratureReview}
\input{Capitoli/DEM}
\input{Capitoli/CFD}
\input{Capitoli/ANN}
\input{Capitoli/Method}
\input{Capitoli/NumericalSimulation}
\input{Capitoli/ANNTraining}
\input{Capitoli/ExperimentalCharacterization}
% \input{Capitoli/DEMParameters}
% \input{Capitoli/CFDParameters}
...
%\input{Capitoli/BondedBehavior}
\input{Capitoli/ResultsAndDiscussion}
\input{Capitoli/Influence}
\input{Capitoli/Extrapolation}
\input{Capitoli/Validation}
\input{Capitoli/Polidispersity}
%\input{Capitoli/MassHopperFlowSimulation}
\input{Capitoli/Applications}
\input{Capitoli/SinterPlant}
\input{Capitoli/BlastFurnace}
