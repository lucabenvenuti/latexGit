...
%\input{Paragrafi/Scopeofwork}
%\input{Paragrafi/Stages}
%\input{Paragrafi/Referencescollection}

%\input{Paragrafi/Materials}
%\input{Paragrafi/DEMParameters}
%\input{Paragrafi/Demcharacterizationworkflowcoarseparticles}
%\input{Paragrafi/CFDemcharacterizationworkflowcoarseparticles}
% \input{Paragrafi/BehaviorInvestigation}
\input{Paragrafi/Modelidentification}
%\input{Paragrafi/Application1SinterChute}
%\input{Paragrafi/Application2Raceway}
%\input{Paragrafi/Thesis}
%\input{Paragrafi/CFDConference}
