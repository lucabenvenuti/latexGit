...
\newcommand{\myTitle}{Report} % titolo
\newcommand{\myDegree}{Tesi di laurea}                       % tipo di tesi
\newcommand{\myUni}{JKU} % universit\`a
\newcommand{\myFaculty}{Strongmuslehre}    % facolt\`a
\newcommand{\myDepartment}{Institute of \\ Registration and Control \\ of Mechatronical Systems}        
% dipartimento
\newcommand{\myOtherProf}{Thomas \textsc{Lichtenegger}}    %DI~Dr.~
\newcommand{\myProf}{Luigi \textsc{del Re}}     %DI~Dr.~         %
...
\newcommand{\myPhd}{Ferrari} % titolo
