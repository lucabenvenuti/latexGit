...
where $F_n$ is the normal component and \ac{mus} is the coefficient of sliding
friction, one of the particle-based $DEM$ parameter we investigated, 
another being the coefficient of rolling friction (\ac{mur}). 
...
torque counteracting the rotation of the particle. The \ac{mur} parameter enters the 
...
The last two particle-based $DEM$ parameters we investigated were \ac{rhop}
and the coefficient of restitution (\ac{CoR}) as defined by Ai. et al.
\cite{RefWorks:131}.\\
