...
\info{Decide if keep the whole chapter, or just put a brief description of the
experiment in the numerical section, as explanation for the simulation design,
and put here only the experimental results.}
