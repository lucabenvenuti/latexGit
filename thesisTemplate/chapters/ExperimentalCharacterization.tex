...
On the left column of Table \ref{tab:23aor} the results of the tests performed
on the various materials can be seen.
...
two large scale dynamic angle of repose tests were performed.
In this case coarse iron ore and sinter were poured from a chute, like in Fig.
\ref{fig:307DSC_2536}.
Once removed the safety cylindrical container, useless for this test (Fig.
\ref{fig:308DSC_2552}), a laserscan apparatus proceeded to determine the large
scale \acs{AoR}.
The results can be gound in the right column of Table \ref{tab:23aor}.\\
We can see how the values are inferior to their static counterparts.
The two main reasons for this behaviour are, of course, the dinamicity of the
test and the large scale of the setup.
\input{images/309aorlargescale}
...
bulk value, see Eq. \ref{eq:phi_ps} \cite{RefWorks:118}.\\
