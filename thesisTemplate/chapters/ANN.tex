...
Further, \citet{RefWorks:192} developed a tool for Gaussian processes inference
and prediction, although we constrained ourselves to the case of exact inference
