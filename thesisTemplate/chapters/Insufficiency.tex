...
\improvement{More words on motivation: industrial processes. 1)Ask MB brochure
on sinter cooler. 2) Ask TL and CF material on raceway (cite Alice's thesis).} 
However, a univocal
...
In their original formulation of $DEM$, the discrete element method used in
