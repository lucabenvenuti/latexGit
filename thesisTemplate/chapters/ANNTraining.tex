...
\input{tables/34weightsoriginalsinterfinesct}
\input{tables/35weightssinterfineaor}
...
For the limestone fine we obtained reasonable box plots, but also comsistent
