\begin{figure}[htbp]
  ...
  \subfloat[SCT Bayesian linear regressor.]{
	  \includegraphics[width=.70\columnwidth]{images/137SCTBayesianLinearRegressor}
	  \label{fig:137SCTBayesianLinearRegressor}
  }
  \\
    \subfloat[SCT Gaussian non linear regressor.]{
	  \includegraphics[width=.70\columnwidth]{images/138SCTGaussianNonLinearRegressor}
	  \label{fig:138SCTGaussianNonLinearRegressor}
  }
  \\
 % \hfill
  \subfloat[SCT ANN non linear regression.]{
	  \includegraphics[width=.70\columnwidth]{images/139SCTANNNonLinearRegressor}
	  \label{fig:139SCTANNNonLinearRegressor}
  }
  \caption[Regressions comparison for the \acs{mupsh}]{Regressions comparison
  for the \acs{mupsh}. Each point represents a simulation. In blue the regression, or interpolation, line.}
