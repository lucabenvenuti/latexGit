...
\usepackage[pdftex,usenames,dvipsnames]{xcolor} % provides colours
% define some colors
...
\usepackage{xargs} 
\usepackage[prependcaption,colorinlistoftodos,textsize=small]{todonotes} %
...
\fancypagestyle{mainmatter}{%
  ...
  \fancyhead[R]{\nouppercase{\rightmark}}% Page number in header Right
  \fancyfoot[C]{-- \thepage\ --}
}
...
\usepackage[printonlyused,footnote]{acronym}	% provides the acronym
% handling
...
\hypersetup{
	pdfpagelabels,
	%colorlinks=true, linkcolor=blue, urlcolor=blue, citecolor=green
...
% \tikzstyle{relation} = [top color=white, bottom color=white!20, 
%                                   draw=red!50!black!100, drop shadow]
\tikzstyle{relation} = [draw, fill=white!20, diamond, 
    minimum height=3em, minimum width=6em]
...
%todo notes
\usepackage[prependcaption,colorinlistoftodos,textsize=small]{todonotes} %
\newcommand{\wrong}[2][1]{\todo[inline,linecolor=red,backgroundcolor=red!25,bordercolor=red,#1]{#2}}
