...
\hline
    ...
    \ac{mus} & mean  & 0.831 & 0.177 & 0.664 \\
    $(-)$   & std. dev. (SD) & 0.097 & 0.095 & 0.029 \\
          & range (\ac{R}) & 0.9   & 0.9   & 0.9 \\
          & SD / R & 0.108 & 0.106 & 0.032 \\
          \hline
    \ac{mur} & mean  & 0.692 & 0.830 & 0.916 \\
    ...
    $(-)$   & std. dev. (SD) & 0.104 & 0.073 & 0.065 \\
          & range (\ac{R}) & 0.4   & 0.4   & 0.4 \\
          & SD / R & 0.259 & 0.183 & 0.161 \\
          \hline
    \ac{rhop} & mean  & 2245.7 & 3192.8 & 2283.9 \\
    $(kg/m3)$ & std. dev. (SD) & 80.5  & 277.4 & 67.1 \\
          & range (\ac{R}) & 1500  & 1500  & 1500 \\
