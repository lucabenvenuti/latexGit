...
\input{22regression}
\input{06inputRelationshipTable}
...
\input{05sinterTableExperimental}
\input{13DEMvalidvalues}
\input{36schulzeradar}
\input{37schulzecloud}
\input{38schulze10070aorradar}
