...
Our approach could therefore be used in a specific flow regime for a range of bulk materials 
that can be represented with a defined particle bulk behaviour.\\
