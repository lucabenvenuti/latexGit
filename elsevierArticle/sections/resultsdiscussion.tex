...
\input{images/texCaller/40experimentalsimulation}
\input{tables/05sinterTableExperimental}
...
the $\mu_{psh}$.
The straight line, referred only to the test simulations, is more sensible to
...
Thus, for each bulk parameter we selected the $NN$ with the maximum $R^2$ in the
test line, as stated in the methodology, e.g the one with fifteen neurons for
$\mu_{psh}$.
...
%\input{images/texCaller/29schulzeradarandcloud}
%\input{images/texCaller/35schulze10070aorradarandcloud}
\input{images/texCaller/36schulzeradarandcloudfirst}
\input{images/texCaller/37schulzeradarandcloudsecond}
\input{images/texCaller/38schulze10070aorradarandcloudfirst}
\input{images/texCaller/39schulze10070aorradarandcloudsecond}
