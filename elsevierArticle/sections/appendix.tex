...
based over the $JSCT$.
% The layout of the simulation geometry can be seen in Fig.
 % \ref{fig:09simGeometry}.
...
static angle of repose ($AOR$) tester. % (Fig. \ref{fig:05aor}).
